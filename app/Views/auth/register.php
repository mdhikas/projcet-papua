        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="<?= route_to('register') ?>" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control <?php if (session('errors.nim')) : ?>is-invalid<?php endif ?>" placeholder="NIM/NID/NIK" name="nim" value="<?= old('nim') ?>">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user"></span>
                            </div>
                ...
                <p><?= lang('Auth.alreadyRegistered') ?> <a href="<?= route_to('login') ?>l" class="text-center"><?= lang('Auth.signIn') ?></a></p>
            </div>
            <!-- /.form-box -->
        </div><!-- /.card -->
    </div>
